...
std::vector<at::Tensor> foreach_tensor_lerp_ternary_cuda(
  ...
  auto tensor_lists = make_tensor_lists(
...
void foreach_tensor_lerp_ternary_cuda_(
  ...
  auto tensor_lists =
      make_tensor_lists(tensors1.vec(), tensors2.vec(), tensors3.vec());
  AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
      at::ScalarType::Half,
      at::ScalarType::BFloat16,
      tensors1[0].scalar_type(),
...
std::vector<at::Tensor> foreach_tensor_lerp_list_cuda(
  ...
  auto tensor_lists =
      make_tensor_lists(tensors1.vec(), tensors2.vec(), std::move(vec_res));
...
void foreach_tensor_lerp_list_cuda_(
  ...
  auto tensor_lists = make_tensor_lists(tensors1.vec(), tensors2.vec());
  AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
      at::ScalarType::Half,
      at::ScalarType::BFloat16,
      tensors1[0].scalar_type(),
